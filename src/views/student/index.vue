...
<!--        </el-form-item>-->
<!--        <el-form-item label="学号" :rules="rules.registration" prop="registration">-->
<!--          <el-input v-model="newStudent.registration" placeholder="请输入班级"></el-input>-->
<!--        </el-form-item>-->
...
<!--        <el-form-item label="手机号" :rules="rules.phone" prop="phone">-->
<!--          <el-input v-model="newStudent.phone" placeholder="请填入手机号"></el-input>-->
<!--        </el-form-item>-->
...
<!--        <el-table-column  prop="registration" width="100" label="学号"  align="center"></el-table-column>-->
...
<!--        <el-table-column  prop="phone" width="110" label="手机号"  align="center"></el-table-column>-->
...
<!--            <span style="margin-right: 10px" v-if="scope.row.education == null">无</span>-->
<!--          </template>-->
<!--        </el-table-column>-->

<!--        <el-table-column  prop="scoreTime" width="80" label="违纪次数"  align="center"></el-table-column>-->

<!--        <el-table-column  prop="score" width="80" label="违纪扣分"  align="center"></el-table-column>-->
...
<!--    customClass: 'delete-student-confirm'  // 自定义类名-->
<!--  }).then(() => {-->
<!--    //2. 发送AJAX请求-->
...
<!--        iconClass: 'none',-->
<!--        dangerouslyUseHTMLString: true,  // 允许使用HTML标签-->
<!--        customClass: 'batch-delete-confirm'  // 自定义类名-->
<!--      }).then(() => {-->
<!--        //用户点击确认按钮-->
...
<!--  border-color: linear-gradient(to top, #96fbc4 0%, #f9f586 100%);-->
<!--}-->
...
<!--/* 批量删除确认弹窗标题样式 */-->
<!--.batch-delete-confirm .el-message-box__title {-->
<!--  position: relative;-->
<!--  padding-left: 12px;-->
<!--}-->

<!--.batch-delete-confirm .el-message-box__title::before {-->
<!--  content: "";-->
<!--  position: absolute;-->
<!--  left: 0;-->
<!--  top: 0;-->
...
<!--/* 删除学员确认弹窗标题样式 */-->
<!--.delete-student-confirm .el-message-box__title {-->
<!--  position: relative;-->
<!--  padding-left: 12px;-->
<!--}-->

<!--.delete-student-confirm .el-message-box__title::before {-->
<!--  content: "";-->
<!--  position: absolute;-->
<!--  left: 0;-->
<!--  top: 0;-->
